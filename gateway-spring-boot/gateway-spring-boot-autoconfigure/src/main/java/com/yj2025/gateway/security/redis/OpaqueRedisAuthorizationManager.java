 ...
 */
@Slf4j
public class OpaqueRedisAuthorizationManager extends AbstracAuthorizationManager {


    public OpaqueRedisAuthorizationManager(PathMatcherAuthoritiesLoader pathMatcherAuthoritiesLoader) {
